...
{abaAtiva === 'admin' && isAdmin && (
  /* Removemos qualquer margem negativa ou hack aqui. Começamos do zero. */
  <div className="w-full"> 
    {viewAdmin === 'menu' ? (
      <div className="animacao-entrada px-5 pb-20">
        <div className="flex items-center justify-between mb-8">
           <h2 className="text-2xl font-black uppercase italic tracking-tighter text-[#ef3340]">Painel Admin</h2>
        ...
        <div className="grid grid-cols-1 gap-3">
          <button 
            ...
            className="bg-[#121212] border border-white/5 rounded-3xl p-6 flex items-center gap-4 transition-all active:scale-95 text-left group hover:border-[#ef3340]/30"
          >
            ...
            <div>
              <span className="font-black text-lg uppercase tracking-tighter text-white/90">Base de Atletas</span>
              <p className="text-[10px] text-white/30 uppercase font-bold tracking-widest leading-tight mt-0.5">Recomeçar Gestão</p>
            </div>
          </button>
        </div>
      </div>
